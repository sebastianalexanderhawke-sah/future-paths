...
// Display name only — never derived from the email username. Checks the
// profile row first, then auth metadata; null means greet without a name.
async function getUserIdentity(): Promise<{
