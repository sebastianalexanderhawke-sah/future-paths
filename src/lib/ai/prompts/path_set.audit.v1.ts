...
Your single question, for EVERY pair of paths: "If each of these two paths became reality, would this person's life look meaningfully different one year from now?"
...
- Differences of tool, agent, timing, scale, sequence, degree, or confidence are NOT different destinations.
